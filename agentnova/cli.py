...
def cmd_models(args):
    ...
    if backend == "bitnet":
        ...
        print(bold("\n🦞 AgentNova R04 BitNet Model (Remote)"))
    ...
    print(bold("\n🦞 AgentNova R04 Models") + dim(" · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def cmd_tools(args):
    ...
    print(bold("\n🦞 AgentNova R04 Tools") + dim(" · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def cmd_modelfile(args):
    ...
    model = args.model
    print(bold(f"\n🦞 AgentNova R04 Modelfile") + dim(" · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
    print()
...
def cmd_skills(args):
    ...
    print(bold("\n🦞 AgentNova R04 Skills") + dim(" · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def cmd_run(args):
    ...
    print(bold("🦞 AgentNova R04") + dim(" · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def cmd_chat(args):
    ...
    print(bold(f"\n🦞 AgentNova R04 chat") + dim(f"  {status} · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def cmd_agent(args):
    ...
    print(bold(f"\n🦞 AgentNova R04 agent mode") + dim(f"  {status} · Written by VTSTech · https://www.vts-tech.org · https://github.com/VTSTech/AgentNova"))
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="agentnova",
        description="🦞 AgentNova R04 - local agentic AI powered by Ollama",
    )
